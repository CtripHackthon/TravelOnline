...
{
    public partial class game_build_factory : System.Web.UI.Page
    {
        ...
        private void loadPage()
        {
            ...
            if (!this.IsPostBack)
            {
                if (Session["field_id"] != null && Session["user_id"] != null)
                {
                    ...
                    factory_enough = checkResource(user_id, field_id);
                    if (factory_enough)
                    {
        ...
        private void displayResourceNeeded()
        {
            ...
            if (Session["user_id"] != null)
            {
                ...
                int[] fresources = building.GetResourcesNeeded(user_id, "a", "3");
